...
},{"./cjs/react-dom.development.js":"node_modules/react-dom/cjs/react-dom.development.js"}],"node_modules/react-strider/dist/index.js":[function(require,module,exports) {
'use strict';
...
var Strider = function (_React$Component) {
  _inherits(Strider, _React$Component);

  function Strider(props) {
    _classCallCheck(this, Strider);

    var _this = _possibleConstructorReturn(this, (Strider.__proto__ || Object.getPrototypeOf(Strider)).call(this, props));
    ...
    _this.children = _react2.default.Children.toArray(_this.props.children);
    return _this;
  }

  _createClass(Strider, [{
    key: 'componentWillReceiveProps',
    value: function componentWillReceiveProps() {
      this.children = _react2.default.Children.toArray(this.props.children);
    }
  }, {
    key: 'hide',
    ...
    key: 'shouldStep',
    value: function shouldStep(index) {
    ...
    value: function next() {
      ...
      var curr = this.state.activeIndex;
      var nextIndex = this.clamp(++curr);
    ...
    value: function goTo(index) {
      ...
      this.hide(function () {
        _this6.setState(function (state) {
          return {
            activeIndex: _this6.clamp(index),
            hiding: false
          };
        }, function () {
          _this6.show();
    ...
    value: function render() {
      var step = this.children[this.state.activeIndex];

      return _react2.default.cloneElement(step, _extends({}, step.props, this.state, {
...
},{"react":"node_modules/react/index.js"}],"src/selectableAnswer.js":[function(require,module,exports) {
"use strict";
...
var SelectableAnswer =
/*#__PURE__*/
function (_React$Component) {
  _inherits(SelectableAnswer, _React$Component);

  function SelectableAnswer(props) {
    var _this;

    _classCallCheck(this, SelectableAnswer);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(SelectableAnswer).call(this, props));
    _this.state = {
      selected: false
    };
    return _this;
  ...
  _createClass(SelectableAnswer, [{
    ...
    key: "color",
    value: function color(top, choice) {
      if (top === choice) {
        return choice ? "cg" : "cr";
      } else {
        return "cw";
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          topSelected = _this$props.topSelected;
      return _react.default.createElement("div", {
        className: "quiz__options ac",
        onClick: function onClick() {
          return _this2.handleClick(choice.answer);
        }
      }, _react.default.createElement("div", {
        className: "".concat(disabled && !selected ? this.color(topSelected, choice.answer) : "", " ").concat(selected ? choice.answer ? "cg" : "cr" : "cw")
      }, choice.item));
    }
  }]);
...
exports.default = SelectableAnswer;
},{"react":"node_modules/react/index.js"}],"src/single.js":[function(require,module,exports) {
"use strict";
...
var _selectableAnswer = _interopRequireDefault(require("./selectableAnswer"));
...
/*#__PURE__*/
function (_Component) {
  _inherits(QuizSingle, _Component);

  function QuizSingle(props) {
    var _this;

    _classCallCheck(this, QuizSingle);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(QuizSingle).call(this, props));
    _this.state = {
      selected: null,
      choice: false,
      disabled: false,
  ...
  _createClass(QuizSingle, [{
    ...
    value: function handleNext() {
      ...
      this.state.selected ? this.props.pushAnswer() : null; // Add a tiny delay to ensure we push the answer up before switching to the next
      // question/answer
    ...
    value: function render() {
      ...
      var _this$state = this.state,
          ...
          hiding = _this$state.hiding,
          answerShow = _this$state.answerShow;
      var _this$props = this.props,
      ...
      return _react.default.createElement("div", {
        ...
        className: "quiz__container container--xl mha"
      }, choice && !hiding ? _react.default.createElement("div", {
        ...
        className: "cw"
      }, selected ? "Correct!" : "Nope"), _react.default.createElement("div", {
        className: "cw",
        ...
        className: "quiz__selections"
      }, _react.default.createElement("div", {
        className: "quiz__selections_nest"
      }, _react.default.createElement("div", {
        className: (0, _classnames.default)("px1 f jcc aic mha")
      }, choices.map(function (singleChoice) {
        return _react.default.createElement(_selectableAnswer.default, {
          key: singleChoice.id,
          topSelected: selected // push selection back down
          ,
          choice: singleChoice,
          disabled: _this4.state.disabled,
          size: singleChoice.fontSize,
          onClick: function onClick(e) {
            return _this4.handleSelected(e);
          }
        });
      })), _react.default.createElement("div", {
        className: "f jcc aic"
      }, choice && _react.default.createElement("div", {
        className: (0, _classnames.default)("f jce quiz__options_next", {
...
exports.default = QuizSingle;
},{"react":"node_modules/react/index.js","classnames":"node_modules/classnames/index.js","./button":"src/button.js","./selectableAnswer":"src/selectableAnswer.js"}],"src/index.js":[function(require,module,exports) {
"use strict";
...
var _reactStrider = require("react-strider");
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        ...
        activeIndex: "0",
        transitionSpeed: 300
      }, _react.default.createElement(_reactStrider.Step, null, function (_ref) {
        var next = _ref.next,
            goTo = _ref.goTo,
            active = _ref.active,
            hiding = _ref.hiding,
        ...
        return _react.default.createElement("div", {
          className: (0, _classnames.default)("step__wrapper", {
            "is-active": active,
            "is-hiding": hiding
          })
        }, _react.default.createElement(QuizStart, {
          next: next
        }));
      }), _react.default.createElement(_reactStrider.Step, null, function (_ref2) {
        var next = _ref2.next,
            goTo = _ref2.goTo,
            active = _ref2.active,
            hiding = _ref2.hiding,
        ...
        }, _react.default.createElement(_single.default, _extends({}, _this2.props, {
          pushAnswer: function pushAnswer() {
            return _this2.setState({
              correct: _this2.state.correct + 1
            });
          },
          number: activeIndex,
          next: next,
          item: _data.default[activeIndex]
        })));
      }), _react.default.createElement(_reactStrider.Step, null, function (_ref3) {
        var next = _ref3.next,
            goTo = _ref3.goTo,
            active = _ref3.active,
            hiding = _ref3.hiding,
      ...
      }), _react.default.createElement(_reactStrider.Step, null, function (_ref4) {
        var next = _ref4.next,
            goTo = _ref4.goTo,
            active = _ref4.active,
            hiding = _ref4.hiding,
      ...
      }), _react.default.createElement(_reactStrider.Step, null, function (_ref5) {
        ...
        }, _react.default.createElement(QuizEnd, _extends({}, _this2.props, {
          score: _this2.state.correct
        })));
      }))));
    }
  }]);
...
function (_React$Component2) {
  _inherits(QuizStart, _React$Component2);

  function QuizStart() {
    _classCallCheck(this, QuizStart);

    return _possibleConstructorReturn(this, _getPrototypeOf(QuizStart).apply(this, arguments));
  }

  _createClass(QuizStart, [{
    key: "render",
    value: function render() {
      var _this3 = this;
      ...
      }, "\u0645\u0632\u0645\u0648\u0646 \u062A\u0627\u0631\u06CC\u062E \u0627\u0641\u063A\u0627\u0646\u0633\u062A\u0627\u0646"), _react.default.createElement(_button.default, {
        classes: "f jcb mt1 regular bold cw",
        clickHandle: function clickHandle() {
          return _this3.props.next();
        }
      }, "\u0627\u0632\u0645\u0648\u0646 \u0631\u0627 \u0634\u0631\u0648\u0639 \u06A9\u0646"));
    }
  }]);
...
function (_React$Component3) {
  _inherits(QuizEnd, _React$Component3);

  function QuizEnd() {
    _classCallCheck(this, QuizEnd);

    return _possibleConstructorReturn(this, _getPrototypeOf(QuizEnd).apply(this, arguments));
  }

  _createClass(QuizEnd, [{
    key: "render",
    value: function render() {
...
},{"react":"node_modules/react/index.js","react-dom":"node_modules/react-dom/index.js","react-strider":"node_modules/react-strider/dist/index.js","classnames":"node_modules/classnames/index.js","./styles.scss":"src/styles.scss","./data":"src/data.js","./button":"src/button.js","./single":"src/single.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
